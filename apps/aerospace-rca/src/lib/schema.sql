...
-- immutable evidence chain that's the the customer pitch's keystone.
-- ============================================================================
...
-- `applied_to_programs` column is what reveals "we fixed this on EA-1
-- but never propagated to LH-0 / NG" in one query.
...
-- RFAs — Requests for Action. The Federal Aerospace Audit AR-26-004 backlog category.
