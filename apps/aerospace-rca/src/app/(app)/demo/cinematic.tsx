...
const TODAY_ID = 'ANM-2026-EA1-027';
...
const ACTS: ActConfig[] = [
  {
    id: 1,
    title: '06:14:23 UTC · EA-1 hot-fire stand 4',
  ...
  },
  {
    ...
    caption: '4 prior matches. One on LH-0 — heritage engine — that a SharePoint search would never have linked.',
    durationMs: 14000,
  },
  {
    id: 3,
    ...
    <ActFrame active={active} number={1} title="Anomaly detected">
      {state.act === 0 ? (
        <p className="text-sm text-muted-foreground">
          Press <span className="font-semibold text-foreground">Kick Off</span> to ingest the EA-1
        ...
        <div className="space-y-3 demo-slide-up">
          ...
          <p className="text-xs text-muted-foreground">
            EA-1 · turbopump · Hot-fire Stand 4 · K. Suresh
          </p>
      ...
      {!safety ? (
        ...
        <div className="space-y-3 demo-slide-up">
          ...
          <div className="rounded bg-destructive/10 border border-destructive/30 px-2 py-1 text-[10px] text-destructive">
            OIG AR-26-004 — &quot;nearly half of PDR RFAs remain open &gt;1 year&quot;
          </div>
        </div>
      )}
    </ActFrame>
